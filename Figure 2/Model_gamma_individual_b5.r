...
save(results_up, results_down, light_levels, file = "Figure 2/gamma_individual_b5_results.RData")
...
ggsave(
  filename = "Figure 2/hysteresis_individual_gamma_thresholds_beta5.pdf",
  plot = p,
  width = 7,
  height = 7,
  units = "in",
