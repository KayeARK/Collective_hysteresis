...
ggsave("Figure 4/analytic_number_of_fps_vary_params_beta.pdf", width = 7, height = 7)
...
print(p_gamma)
ggsave("Figure 4/beta_distributions_vary_params.pdf", plot = p_gamma, width = 7, height = 7)